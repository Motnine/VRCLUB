...
$mail->addAddress('kol.tsentr.96@bk.ru');     // Кому будет уходить письмо 
...
$mail->Subject = 'Вопрос клиента';
$mail->Body    = '' .$name . ' оставил сообщение. <br>Почта этого пользователя: ' .$email. ' <br>Вопрос: '.$message;
$mail->AltBody = '';
